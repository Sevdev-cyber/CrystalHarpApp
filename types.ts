...
export const SCALES: Record<ScaleType, ScaleNote[]> = {
  ...
  'Mystic E': [
    { label: 'E5', freq: 659.25, color: '#F9A8D4', width: 95 },
    { label: 'F5', freq: 698.46, color: '#F472B6', width: 90 },
    { label: 'G#5', freq: 830.61, color: '#EC4899', width: 85 },
    { label: 'A5', freq: 880.00, color: '#DB2777', width: 80 },
    { label: 'B5', freq: 987.77, color: '#BE185D', width: 75 },
    { label: 'C6', freq: 1046.50, color: '#9D174D', width: 70 },
    { label: 'D#6', freq: 1244.51, color: '#831843', width: 65 },
    { label: 'E6', freq: 1318.51, color: '#FFF1F2', width: 60 },
  ],
  'Stardust C#': [
